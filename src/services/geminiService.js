...
방법 A (OPERATION 컬럼이 있을 때 — 우선 적용):
  ...
  ② DEBALLAST(또는 N-D) 행의 TRO_D*(또는 TRO_S*) 컬럼 값 중 0~15 사이 값 평균 → deballasting_avg
...
Step 3. ECS Data Log 섹션에서 TRO + ECU/FMU 평균 계산 (TRO 수치 전용 — 운전 횟수 산정 불가)
  ...
  - OPERATION 컬럼이 있으면: BALLAST/N-B 행 → ballasting_avg, DEBALLAST/N-D 행 → deballasting_avg (TRO 계산에만 사용)
